...
export default {
  ...
  methods: {
    ...
    handleOk() {
      ...
      this.form.startDate = this.form.startDate.format('YYYY-MM-DD');
      this.form.endDate = this.form.endDate.format('YYYY-MM-DD');
      // Hãy lưu ý rằng giờ đây bạn có thể trực tiếp sử dụng this.form để lấy các giá trị
      // Nếu muốn thực hiện thêm xử lý, hãy làm ở đây
